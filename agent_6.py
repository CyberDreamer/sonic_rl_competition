...
class CNQAgent:
    ...
    def act(self, state, prev_action, reward, pos_x):
    ...
    def replay(self, batch_size):
        ...
        x_2 = np.array(x_2)
        y = np.array(y)
        self.model.fit([x_1, x_2], y, epochs=1, verbose=0, batch_size=1)
